...
ENV QTUM_RELEASE_URL https://github.com/qtumproject/qtum/releases/download/v22.1
ENV QTUM_ARCHIVE qtum-22.1-x86_64-linux-gnu.tar.gz
ENV QTUM_FOLDER qtum-22.1
